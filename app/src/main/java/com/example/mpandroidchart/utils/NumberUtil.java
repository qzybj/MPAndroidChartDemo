...
public class NumberUtil {
    ...
    public static double parse2Double(EditText et){
        try {
            return Double.parseDouble(TextViewUtils.getText(et));
        }catch (Exception e){
            LogUtils.e(e);
        }
        return -1 ;
    ...
    public static int parse2Int(EditText et){
        return parse2Int(TextViewUtils.getText(et));
    }
    ...
    public static float parse2Float(EditText et){
        return parse2Float(TextViewUtils.getText(et));
    }
    ...
    public static BigDecimal parse2BigDecimal(EditText et){
        return parse2BigDecimal(TextViewUtils.getText(et));
    }
